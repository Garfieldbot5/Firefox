...
async function connectToWA() {
  ...
  console.log("Connecting Firefox 🎀");
  ...
  robin.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      console.log("Firefox 🎀 installed successful ✅");
      console.log("Firefox 🎀 connected to whatsapp ✅");

      let up = `Firefox 🎀 connected successful ✅`;
      let up1 = `Hello Firefox 🎀, I made bot successful`;

      robin.sendMessage(ownerNumber + "@s.whatsapp.net", {
        image: {
          url: `https://i.postimg.cc/SKWWycnC/2f219c4e-35ba-41b3-bb11-91fdfe78291f.jpg`,
        },
        caption: up,
      });
    }
